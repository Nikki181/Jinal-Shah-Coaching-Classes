...
{
    public class Visitor_our_workController : Controller
    {
        //
        // GET: /Visitor/Visitor_our_work/

        Database1Entities _entity = new Database1Entities();
        our_work_visitor _o = new our_work_visitor();
        and_our_work_tbl _otbl = new and_our_work_tbl();


        public ActionResult Index()
        {
            List<our_work_visitor> objlist = new List<our_work_visitor>();
            ...
            if (q.Count > 0)
            {
                ...
                {
                    objlist.Add(new our_work_visitor()
                    {
            ...
            return View("new_our_work", objlist);
        }
        public ActionResult load_view_detail(int id)
        {
            ...
            return View("detail_view_our_work_visitor", objlist);
        }
